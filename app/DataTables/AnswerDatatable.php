...
class AnswerDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.answers.actions.checkbox')
            ->addColumn('edit', 'admin.answers.actions.edit')
            ->addColumn('delete', 'admin.answers.actions.delete')
            ->rawColumns([
    ...
    {
        return $this->builder()
        ->setTableId('answerdatatable-table')
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('admin.new_answer'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
                ...
                ->printable(false),
            Column::make('id'),
            Column::make('title')->title(trans('admin.answer'))->className('text-center'),
            Column::make('order')->title(trans('admin.order'))->className('text-center'),
